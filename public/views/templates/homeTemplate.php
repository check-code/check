				...
				<div ng-switch-when="login">
	                <form>
						<div class="row form-group">
							<input class="col-md-11" type="text" name="email" required="required" placeholder="Email">
							<div class="col-md-1">
								<!-- icons image -->
								<img src="assets/logos/aicte.png">
							</div>
						...
						<div class="row form-group">
							<input class="col-md-11" type="password"  name="password" required="required" placeholder="Password">
							<div class="col-md-1">
								<!-- icons image -->
								<img src="assets/logos/aicte.png">
							</div>
